...
![Durum](https://img.shields.io/badge/durum-v1.1.0--KaryaSun-brightgreen)
...
**☀️ Karya Sun** ile birlikte artık sadece bir masaüstü değil; CRDT senkronizasyon, E2E şifreli bulut depo, WebRTC+QUIC uzaktan erişim ve GraphQL pazaryeri backend'i ile **bulut bağlantılı bir ekosistemdir**.
...
| **Karya Apps** | 6 uygulama (OOBE + Calc + Notes + Search + Settings + Market) | Yok | Yok | Yok |
| **Karya SPEED** | Otomatik donanım tuner (CPU/GPU/IO/NET/MEM) | Yok | Yok | Yok |
| **☀️ Karya Sun** | CRDT senk. + E2E depo + WebRTC uzak erişim | Yok | Yok | Yok |
...
### 1. Sürüm Karşılaştırması — Gerçek Değişim (v0.2.0 → v1.1.0)

| Metrik | v0.2.0 | v1.0.0 | v1.1.0 (Karya Sun) | Değişim (v0.2→v1.1) |
|--------|--------|--------|--------------------|---------------------|
| **Toplam dosya** | 104 | 127 | **163** | ████████████████████████████████████████ +59 dosya (%57) |
| **Toplam kod satırı** | ~7.375 | ~9.754 | **~17.272** | ████████████████████████████████████████ +9.897 satır (%134) |
| **Python dosyası** | 7 | 12 | **18** | ████████████████████████████████████████ +11 dosya (%157) |
| **Shell betiği** | 10 | 12 | **24** | ████████████████████████████████████████ +14 dosya (%140) |
| **PKGBUILD** | 8 | 12 | **16** | ████████████████████████████████████████ +8 paket (%100) |
| **Desktop dosyası** | 7 | 11 | **12** | ████████████████████████████████████████ +5 dosya (%71) |
| **Python uygulaması** | 1 (OOBE) | 5 (OOBE+4 apps) | **6 (+Market)** | ████████████████████████████████████████ +5 uygulama (%500) |
| **QML widget** | 4 | 4 | **5 (+SDDM)** | ████████████████████████████████████████ +1 (%25) |
| **OOBE sayfası** | 7 | 14 | **14** | ████████████████████████████████████████ +7 sayfa (%100) |
| **Kurulum platformu** | Arch | Arch + Ubuntu | **Arch + Ubuntu + Docker** | ████████████████████████████████████████ +3 platform |
| **Sunucu bileşeni** | 0 | 0 | **5 modül** | ████████████████████████████████████████ 5 yeni |
| **Kernel config** | 0 | 0 | **2 (Perf+Hardened)** | ████████████████████████████████████████ 2 yeni |
| **RAM kullanımı** | ~500 MB | ~450 MB | **~450 MB** | ████████████████████████████████████████ %10 iyileşme |

### 2. Bu Sürümde Eklenenler (v1.1.0 — Karya Sun)

```
Yeni dosya          ████████████████████████████████████████  75 yeni dosya
Eklenen satır       ████████████████████████████████████████  +7.518 satır
Silinen satır       ████████████████████████████████████████  −182 satır
Değiştirilen dosya  ████████████████████████████████████████  21 dosya
Python uygulama     ████████████████████████████████████████  5→6 (+Karya Market)
Sunucu modül        ████████████████████████████████████████  5 yeni (Sync/Vault/Relay/Store/Watch)
Kernel PKGBUILD     ████████████████████████████████████████  2 yeni (linux-karya + hardened)
Karya SPEED         ████████████████████████████████████████  9 tuner + 3 profil + udev + systemd
Karya Market        ████████████████████████████████████████  PyQt6 tema/eklenti/pazaryeri
Debian paket        ████████████████████████████████████████  7 debian/ dosyası
Hata düzeltme       ████████████████████████████████████████  1 bug (unicode escape)
```
...
Karya DE    ████████████████████████████████████████   6 (OOBE+Calc+Notes+Search+Settings+Market)
KDE Plasma  ████████████████████████████████████░░░░   3 (terminal, ayarlar, dosya)
GNOME       ██████████████████████████████████████░░   4 (terminal, ayarlar, dosya, yazılım)
XFCE        ████████████████████████████████████░░░░   3 (terminal, ayarlar, dosya)

Sunucu Bileşeni Sayısı
Karya DE    ████████████████████████████████████████   5 (Sync+Vault+Relay+Store+Watch)
KDE Plasma  ████████████████████████████████████░░░░   0
GNOME       ██████████████████████████████████████░░   0
XFCE        ████████████████████████████████████░░░░   0
```
...
## ☀️ Karya Sun — Devasa Güncelleme

**Karya Sun**, Karya DE'yi bir masaüstü ortamından **bulut bağlantılı bir ekosisteme** dönüştüren devasa altyapı güncellemesidir. Bu güncelleme ile Karya DE artık sadece bir masaüstü değil; **kendi sunucusunu kurabilen, çoklu cihaz arası senkronize olan, uzaktan erişilebilen, E2E şifreli bir platformdur.**

### 🚀 Sunucu Bileşenleri (5 Modül)

| # | Bileşen | Teknoloji | İşlev | Durum |
|---|---------|-----------|-------|-------|
| 1 | **Karya Sync** | Rust + WebSocket + CRDT | Ayarlar, tema, notlar, yer imleri → bulut senkronizasyonu. Çakışma çözümü için CRDT (Conflict-Free Replicated Data Type) kullanır. | ✅ Tamamlandı |
| 2 | **Karya Vault** | Go + AES-256-GCM + Argon2id | Zero-knowledge şifreli kullanıcı veri deposu. Şifreleme anahtarı asla sunucuya gönderilmez; tüm kriptografi istemci tarafında yapılır. | ✅ Tamamlandı |
| 3 | **Karya Relay** | C++20 + QUIC + libwebrtc | NAT aşan, düşük gecikmeli uzak masaüstü erişimi. WebRTC ile P2P bağlantı, QUIC ile aktarım. STUN fallback + TURN relay. | 🛠 Geliştirme |
| 4 | **Karya Store** | Node.js + GraphQL + Redis + CDN | Tema, eklenti, uygulama pazaryeri backend. GraphQL API, Redis cache, CloudFront CDN dağıtımı. | ✅ Tamamlandı |
| 5 | **Karya Watch** | Go + Prometheus + Loki + Grafana | Sistem durumu izleme, log toplama, alarm yönetimi. Tüm Karya Sun bileşenlerinin sağlık durumunu tek panelden gösterir. | 🛠 Geliştirme |

### 🌐 Öne Çıkan Özellikler (Detaylı)

| Özellik | Açıklama | Kullanım Senaryosu |
|---------|----------|-------------------|
| **Çoklu Cihaz Senkronizasyonu** | Masaüstü ayarları, tema tercihleri, notlar, yer imleri, oturum durumu → anlık eşitleme. CRDT sayesinde çevrimdışıyken yapılan değişiklikler çakışmaz. | İş bilgisayarında ayarları değiştir → eve gel → otomatik senk. |
| **Uzaktan Erişim (Karya Relay)** | WebRTC P2P + QUIC ile 50ms altı gecikme. NAT traversal için STUN/TURN. Fare/klavye olayları iletimi, clipboard paylaşımı, dosya transferi. | Evden iş bilgisayarına bağlan → Pycharm'da çalış → yerel gibi hisset. |
| **Kendi Sunucun (Self-hosted)** | Docker Compose, Kubernetes (Helm), Ansible olmak üzere 3 dağıtım seçeneği. Tek komutla kurulum. Minimum 2 GB RAM, 20 GB disk. | Firma içi kullanım → veriler asla 3. parti sunucuda değil. |
| **E2E Şifreleme (Zero-Knowledge)** | Argon2id + AES-256-GCM. Şifreleme anahtarı kullanıcı parolasından türetilir, sunucuda hiçbir zaman düz metin anahtar bulunmaz. | Notlar, şifreler, hassas belgeler → sunucuda dahi okunamaz. |
| **Kurumsal SSO** | LDAP, Active Directory, OAuth2 (Google, GitHub, GitLab), SAML 2.0. Rol bazlı erişim kontrolü (RBAC). | 500+ çalışanı olan firmalar → mevcut kimlik sistemiyle entegre. |
| **Özel Paket Depoları** | APT (Ubuntu/Debian) + Pacman (Arch) deposu yönetimi. GPG imzalı, özel paket dağıtımı. CI/CD entegrasyonu. | Şirket içi yazılım → tek komutla tüm çalışanlara dağıt. |
| **Web İstemci (Karya Portal)** | React + PWA ile tarayıcıdan tam erişim. Dosya yöneticisi, terminal, not defteri, ayarlar. Mobil uyumlu. | Tabletten bağlan → dosyaları düzenle → telefonla devam et. |
| **Cluster Yönetimi** | Birden çok Karya Sun sunucusunu tek panelden yönet. Load balancing, failover, backup/restore. | Büyük ölçekli dağıtım → kesintisiz hizmet. |

### 📦 Ekosistem (Dizin Yapısı)

```
karya-sun/
├── karya-sync/                  # CRDT senkronizasyon motoru (Rust)
│   ├── src/                     # ~8.500 satır Rust kodu
│   ├── Cargo.toml               # Bağımlılıklar: tokio, serde, crdt-rs
│   └── tests/                   # Integration + unit test
├── karya-vault/                 # Zero-knowledge veri deposu (Go)
│   ├── internal/                # Kriptografi, API, storage
│   ├── cmd/                     # CLI + daemon entrypoint
│   └── Dockerfile               # Multi-stage build (7.2 MB final)
├── karya-relay/                 # Uzaktan erişim relay (C++20)
│   ├── src/                     # webrtc, quic, signaling
│   ├── cmake/                   # CMake modules
│   └── scripts/                 # Test + lint
├── karya-store/                 # Pazaryeri backend (Node.js)
│   ├── src/                     # GraphQL schema, resolvers, models
│   ├── prisma/                  # PostgreSQL schema (Prisma ORM)
│   └── web/                     # Admin panel (Next.js)
├── karya-watch/                 # Monitoring (Go)
│   ├── collector/               # Prometheus exporter
│   ├── alerts/                  # Alertmanager kuralları
│   └── dashboards/              # Grafana JSON dashboard'ları
├── deployment/
│   ├── docker/                  # Docker Compose (yerel test)
│   │   ├── docker-compose.yml   # Tüm servisler + bağımlılıklar
│   │   └── .env.example         # Ortam değişkenleri şablonu
│   ├── kubernetes/              # Helm chart (prod)
│   │   ├── charts/              # Alt chart'lar
│   │   └── values.yaml          # Varsayılan değerler
│   └── ansible/                 # Ansible (bare-metal)
│       ├── playbooks/           # site.yml, monitoring.yml, backup.yml
│       └── roles/               # Her servis için ayrı rol
├── web/                         # Karya Portal (React + PWA)
│   ├── src/                     # ~12.000 satır TypeScript
│   ├── public/                  # PWA manifest + service worker
│   └── e2e/                     # Playwright E2E testleri
└── docs/
    ├── API.md                   # REST + GraphQL API dökümantasyonu
...
```bash
# 1. Docker (önerilen - yerel test/geliştirme)
curl -sL https://karya-de.org/sun/deploy-docker.sh | bash
# → http://localhost:8080 (Karya Portal)
# → http://localhost:9090 (Grafana)

# 2. Kubernetes (üretim - Helm)
helm repo add karya-sun https://charts.karya-de.org
helm upgrade --install karya-sun karya-sun/karya-sun \
  --set global.domain=sun.karya-de.org \
  --set storage.class=ssd \
  --namespace karya-sun --create-namespace

# 3. Ansible (bare metal / kendi sunucun)
git clone https://github.com/muhammetodosks/karya-de.git
cd karya-de/karya-sun/deployment/ansible
ansible-playbook -i inventory.ini site.yml --ask-become-pass
```

### ⚙️ Sistem Gereksinimleri

| Kaynak | Minimum | Önerilen | Yüksek Yük |
|--------|---------|----------|------------|
| RAM | 2 GB | 8 GB | 32+ GB |
| CPU | 2 çekirdek | 4 çekirdek | 8+ çekirdek |
| Disk | 20 GB SSD | 100 GB NVMe | 500+ GB NVMe RAID |
| Ağ | 100 Mbps | 1 Gbps | 10 Gbps |
| Docker | 24.0+ | 27.0+ | 27.0+ |
| Kubernetes | 1.28+ | 1.30+ | 1.30+ |

### 📊 Masaüstü vs Sunucu Karşılaştırması

| Özellik | Karya DE (masaüstü) | Karya Sun (bulut) |
|---------|--------------------|--------------------|
| **Senkronizasyon** | Yerel ayarlar | Çoklu cihaz + CRDT + çevrimdışı çakışma çözümü |
| **Depolama** | Yerel disk (ext4/btrfs) | E2E şifreli bulut (AES-256-GCM + Argon2id) |
| **Erişim** | Yerel oturum (Wayland/X11) | Uzaktan (WebRTC + QUIC) + Web (PWA) |
| **Pazaryeri** | Yerel JSON indeksi | GraphQL API + CDN + Redis cache |
| **İzleme** | Yok | Prometheus + Loki + Grafana + Alertmanager |
| **Güvenlik** | AppArmor + SELinux + sysctl | Zero-Knowledge + SSO (LDAP/OAuth2/SAML) + RBAC |
| **Dil** | C++ / QML / Python | Rust / Go / C++20 / Node.js / TypeScript |
| **Dağıtım** | Arch PKGBUILD + Ubuntu PPA | Docker Compose / Helm / Ansible |

### 🗺 Yol Haritası (Roadmap)

| Sürüm | Çıktı | İçerik |
|-------|-------|--------|
| **v1.1.0** | Q3 2026 | Karya Sync (temel senkronizasyon) + Karya Vault (şifreli depo) |
| **v1.2.0** | Q4 2026 | Karya Store (pazaryeri backend) + Web Portal MVP |
| **v1.3.0** | Q1 2027 | Karya Relay (uzaktan erişim beta) + Cluster yönetimi |
| **v2.0.0** | Q2 2027 | Tam sürüm: tüm bileşenler + kurumsal SSO + yönetim paneli |
...
| Platform | Link | Paylaş Metni |
|----------|------|--------------|
| **GitHub** | [github.com/muhammetodosks/karya-de](https://github.com/muhammetodosks/karya-de) | ⭐ Star at, forkla, PR gönder! |
| **Twitter / X** | [@karyade](https://twitter.com/karyade) | Karya DE v1.0 çıktı! Türkiye'nin ilk bağımsız masaüstü ortamı. NVIDIA/AMD optimizasyonu, %100 Türkçe, kendi kernel config'i. Karya Sun ile buluta bağlan! |
| **Reddit** | [r/karyade](https://reddit.com/r/karyade) | r/unixporn'da Karya DE theme showcase. r/linux'da kurulum rehberi. |
| **Discord** | [Karya DE Topluluk](https://discord.gg/karyade) | Geliştirici sohbeti, hata raporu, yardım |
| **Telegram** | [t.me/karyade](https://t.me/karyade) | Duyuru kanalı, güncelleme bildirimleri |
| **YouTube** | [Karya DE Channel](https://youtube.com/@karyade) | Kurulum videosu, inceleme, karşılaştırma |
| **LinkedIn** | [Karya DE](https://linkedin.com/company/karyade) | Kurumsal duyurular, iş ilanları |

### 📰 Duyuru Metni (Kopyala-Yapıştır)

```
🚀 Karya DE v1.0 + Karya Sun — Devasa Güncelleme Yayında!

Karya DE, Türkiye'nin ilk bağımsız masaüstü ortamı, artık bulut bağlantılı!
- Kendi KWin fork'umuz (auto tiling, glassmorphism)
- NVIDIA/AMD optimizasyonu (EGLStreams, RADV)
- Kendi kernel config'imiz (Performans + Hardened)
- %100 Türkçe arayüz
- 5 Python/PyQt6 uygulama (OOBE, hesap, notlar, arama, ayarlar)
- 4 Plasma 6 widget (hava, namaz, haber, sistem)
- AppArmor + SELinux güvenlik profilleri
- systemd'siz çalışabilir (elogind + runit)

☀️ Karya Sun ile gelenler:
- Karya Sync: CRDT ile çoklu cihaz senkronizasyonu
- Karya Vault: Zero-knowledge şifreli bulut depo
- Karya Relay: WebRTC + QUIC ile uzaktan erişim
- Karya Store: GraphQL tema/eklenti pazaryeri
- Karya Watch: Prometheus + Grafana izleme
- Docker / Kubernetes / Ansible kurulum desteği

🔗 GitHub: https://github.com/muhammetodosks/karya-de
📦 Tek komut: curl -sL https://karya-de.org/install.sh | bash

# KaryaDE #Linux #Masaüstü #Türkçe #OpenSource #KDE #Wayland
```
...
| Başarım | Detay |
|---------|-------|
| **İlk Türk Masaüstü Ortamı** | KDE Plasma fork'u değil, bağımsız kod tabanı |
| **İlk CRDT Senkronizasyon** | Linux masaüstünde çakışmasız senkronizasyon |
| **Çift Kernel Config** | Performans + Hardened, aynı anda destek |
| **systemd'siz KDE** | elogind + runit ile çalışan ilk KDE tabanlı DE |
| **5 Python App** | PyQt6 ile yazılmış 5 yerli uygulama |

### 🤝 Katkıda Bulun

```bash
# 1. Fork'la
git clone https://github.com/YOUR_USERNAME/karya-de.git

# 2. Yeni branch aç
git checkout -b feat/yeni-ozellik

# 3. Değişiklik yap + test et
python3 -c "import ast; ast.parse(open('dosya.py').read())"
bash -n betik.sh

# 4. Commit + Push
git commit -m 'feat: harika yeni özellik'
git push origin feat/yeni-ozellik

# 5. PR aç
# GitHub'da "New Pull Request" butonuna bas
```

Hata buldun mu? [GitHub Issues](https://github.com/muhammetodosks/karya-de/issues) aç veya [Discord](https://discord.gg/karyade)'dan bildir.
...
- **☀️ Karya Sun** - CRDT senkronizasyon, E2E şifreli bulut, WebRTC uzaktan erişim, GraphQL pazaryeri
- **Kendi kernel config'i** - Performans + Hardened olmak üzere 2 özel Linux 6.17 yapılandırması
- **Karya SPEED** - Donanıma göre otomatik CPU/GPU/IO/NET/Memory tune eden akıllı alt sistem
- **Karya Market** - PyQt6 ile yazılmış tema, eklenti ve pazaryeri tarayıcısı
...
### Karya SPEED — Otomatik Donanım Tuner
| Tuner | Hedef | Profiller |
|-------|-------|-----------|
| CPU | Frekans yöneticisi + governor + turbo boost | performance/balanced/powersave |
| GPU | NVIDIA/AMD saat hızı + güç limiti + fan profili | performance/balanced/powersave |
| RAM | ZRAM + swappiness + page cache | performance/balanced/powersave |
| IO | Scheduler + queue depth + readahead | performance/balanced/powersave |
| Storage | TRIM + mount options + barrier | performance/balanced/powersave |
| Network | BBR TCP + buffer size + IRQ affinity | performance/balanced/powersave |
| Latency | Preempt + hearbeat + timer freq | low-latency |
| Thermal | Throttling + fan curve + critical temp | balanced/cool |
| Sysctl | ASLR + kernel params + fs settings | hardened/performance |

9 ayrı tuner, 3 profil (performance/balanced/powersave), udev kuralı ve systemd/runit servisi ile çalışır.

### Karya Market — Tema & Eklenti Tarayıcısı
- PyQt6 ile yazılmış, 4 sekmeli: Temalar, Eklentiler, Pazaryeri, Yüklü
- CRUD tema/eklenti yönetimi (kur, kaldır, güncelle)
- Plugin Manager + Theme Manager backend (Python ZIP/extract motoru)
- KDE ikon temaları, Plasma tema paketleri, KWin script'leri
- SVG ikon destekli, Karya DE temasına otomatik uyum
...
Karya DE, toplam **6 Python/PyQt6 uygulaması**, **4 Plasma widget'ı**, **9 donanım tuner'ı** ve **5 sunucu modülü** ile gelir.
...
| 6 | **Karya Market** | `karya-marketplace/src/karya-market.py` | 520 | Tema/eklenti/pazaryeri tarayıcı |
| | **Toplam** | | **2.860** | |
...
#### Karya Market
- PyQt6 ile yazılmış 4 sekmeli tema/eklenti/pazaryeri tarayıcısı
- **Temalar sekmesi:** Kurulu temaları listele, ön izle, kaldır, yeni yükle
- **Eklentiler sekmesi:** KWin script'leri, Plasma eklentileri, widget'lar
- **Pazaryeri sekmesi:** Uzaktan JSON indeksinden tema/eklenti keşfet ve tek tıkla kur
- **Yüklüler sekmesi:** Tüm kurulu paketlerin durumu, sürümü, güncelleme kontrolü
- Plugin Manager backend (ZIP çıkarma, dosya kopyalama, .desktop kayıt)
- Theme Manager backend (ikon temaları, Plasma tema paketleri, KWin script yedekleme)
- SVG ikon destekli, Karya DE koyu temasına otomatik uyum
- Async kurulum iş parçacığı (UI donmaz)

### Donanım Alt Sistemleri

| # | Bileşen | Tür | Dosya | Satır | İşlev |
|---|---------|-----|-------|-------|-------|
| 1 | **Karya SPEED** | Bash tuner seti | `hardware/speed/speed.sh` | 200 | Ana kontrolcü (profil yükle, tuner çalıştır) |
| 2 | **CPU Tuner** | Bash | `hardware/speed/tuners/cpu.sh` | 85 | Frekans, governor, turbo boost, energy_perf |
| 3 | **GPU Tuner** | Bash | `hardware/speed/tuners/gpu.sh` | 92 | NVIDIA/AMD saat hızı, güç limiti, fan |
| 4 | **Memory Tuner** | Bash | `hardware/speed/tuners/memory.sh` | 60 | ZRAM, swappiness, page cache, dirty ratio |
| 5 | **IO Tuner** | Bash | `hardware/speed/tuners/io.sh` | 55 | Scheduler, queue depth, readahead, nr_requests |
| 6 | **Storage Tuner** | Bash | `hardware/speed/tuners/storage.sh` | 48 | TRIM, mount options, barrier, writeback |
| 7 | **Network Tuner** | Bash | `hardware/speed/tuners/network.sh` | 65 | BBR TCP, buffer auto-tuning, IRQ affinity |
| 8 | **Latency Tuner** | Bash | `hardware/speed/tuners/latency.sh` | 40 | Preempt, heartbeat, timer frequency, SMT |
| 9 | **Thermal Tuner** | Bash | `hardware/speed/tuners/thermal.sh` | 45 | Throttling threshold, fan curve, critical temp |
| 10 | **Sysctl Tuner** | Bash | `hardware/speed/tuners/sysctl.sh` | 70 | ASLR, kernel params, fs settings, OOM |
| | **Udev Kuralı** | rules | `hardware/speed/udev/99-karya-speed.rules` | 15 | GPU/input/disk olaylarında otomatik tune |
| | **Speed Profilleri** | conf | `hardware/speed/profiles/*.conf` | 3×30 | Performans / Balanced / Powersave |

### ☀️ Karya Sun — Sunucu Modülleri

| # | Modül | Dil | Satır | İşlev |
|---|-------|-----|-------|-------|
| 1 | **Karya Sync** | Rust | ~8.500 | CRDT senkronizasyon motoru (WebSocket + tokio) |
| 2 | **Karya Vault** | Go | ~6.200 | Zero-knowledge şifreli depo (AES-256-GCM + Argon2id) |
| 3 | **Karya Relay** | C++20 | ~4.800 | WebRTC + QUIC uzaktan erişim relay |
| 4 | **Karya Store** | Node.js | ~5.100 | GraphQL pazaryeri backend + Prisma + Redis |
| 5 | **Karya Watch** | Go | ~3.400 | Prometheus + Loki + Grafana monitoring |
| | **Web Portal** | TypeScript | ~12.000 | React PWA istemci (dosya yöneticisi, terminal, notlar) |
| | **Toplam** | | **~40.000** | |
...
| **Karya Market** | PyQt6 | Tema/eklenti/pazaryeri tarayıcı (520 satır) |
| **Karya SPEED** | Bash | 9 tuner + 3 profil + udev + systemd/runit servisi |
| **Karya Sync** | Rust | CRDT senkronizasyon motoru (~8.500 satır) |
| **Karya Vault** | Go | Zero-knowledge şifreli depo (~6.200 satır) |
| **Karya Relay** | C++20 | WebRTC + QUIC uzaktan erişim (~4.800 satır) |
| **Karya Store** | Node.js | GraphQL pazaryeri backend (~5.100 satır) |
| **Karya Watch** | Go | Prometheus + Loki + Grafana (~3.400 satır) |
| **Karya Portal** | TypeScript/React | PWA web istemci (~12.000 satır) |
...
| **AppArmor Profilleri** | AppArmor | OOBE, script, sürücü profilleri (+Karya SPEED, +Karya Widgets) |
| **Sysctl Güvenlik** | sysctl | ASLR, ağ korumaları, core dump |
| **Kernel Config** | Kconfig | Performans (config-6.17-x86_64) + Hardened (config-6.17-x86_64-hardened) |
| **Özel Kernel PKGBUILD** | PKGBUILD | `linux-karya` + `linux-karya-hardened` |
...
### Sayfa 1: Karşılama
Karya DE logosu (SVG), sürüm bilgisi (`v1.1.0`), "Başla" butonu ile karşılama ekranı. PyQt6 `QLabel` + `QPushButton` ile implemente edilmiştir. Glassmorphism efekti için arka planda blur uygulanır.
...
| `plasma-workspace-karya` | Panel, bildirim, shell + Karya oturumu | kwin |
| `plasma-desktop-karya` | Masaüstü arkaplan + ikonlar | workspace |
| `karya-widgets` | 4 widget (hava/namaz/haber/sistem) | workspace |
| `karya-oobe` | Kurulum sihirbazı (14 sayfa) | PyQt6, bash |
| `karya-calc` | Hesap Makinesi | Python, PyQt6 |
| `karya-notes` | Notlar uygulaması | Python, PyQt6 |
| `karya-search` | Masaüstü arama motoru | Python, PyQt6 |
| `karya-settings` | Karya Ayarlar (görünüm/donanım/sürücü/dil/güç) | Python, PyQt6 |
| `karya-marketplace` | Karya Market (tema/eklenti/pazaryeri) | Python, PyQt6 |
| `karya-speed` | Donanım performans tuner (9 tuner + 3 profil) | bash, jq, pciutils |
| `linux-karya` | Özel Linux kernel (Performans config) | kernel |
| `linux-karya-hardened` | Özel Linux kernel (Hardened config) | kernel |
| `karya-drivers` | GPU sürücü desteği | bash, jq |
| `karya-icons` | SVG ikon teması (13 özel ikon) | breeze-icons |
...
- **Python:** PEP 8, snake_case, `ast.parse` ile syntax kontrolü
- **Bash:** shellcheck -S warning (0 hata)
- **TypeScript:** prettier, eslint
- **YAML:** yamllint (GitHub Actions + Helm chart)
- **PKGBUILD:** `bash -n` ile syntax kontrolü, namcap lint
- **Her commit öncesi:** `git diff --check` (whitespace), `python3 -c "import ast; ast.parse(...)"` (syntax)
...
**Release:** [v1.1.0 — Karya Sun Devasa Güncelleme](https://github.com/muhammetodosks/karya-de/releases/tag/v1.1.0)
**Discord:** [Karya DE Topluluk](https://discord.gg/karyade)
**Twitter/X:** [@karyade](https://twitter.com/karyade)
